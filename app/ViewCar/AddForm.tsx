...
import { AddFormSensor } from "../(inside)/sensors/AddSensorsForm";
import { Separator } from "@/components/ui/separator";
import SensorCard from "../(inside)/sensors/sensorCard";
              ...
              <FormControl>
                {image ? (
                  <div className="relative max-w[400px] min-w-[200px] max-h-[400px] min-h-[200px] mt-4">
                    <img src={image} alt="Car Image" className="object-contain" />
